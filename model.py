...
class model(object):
    ...
    def __init__(self, batch_size, max_iters, dropout, model_path, data_ob, log_dir, learnrate_init,
                 ckpt_name, test_ckpt, train_ckpt=[], restore_model=False, restore_step=0, class_num=17, model_ticket="none", is_training=True, output_inf_model=False):
        ...
        self.model_list = ["CNN_v1", "CNN_1st_v1", "EXAMPLE_CNN"]
